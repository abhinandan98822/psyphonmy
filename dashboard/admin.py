...
class ClientTableAdmin(admin.ModelAdmin):
    list_display = ['id', 'name', 'gender','dob', 'age', 'email', 'phone', 'alternate_phone', 'mother_tongue', 'father_name', 'mother_name', 'address', 'branch', 'created_on', 'created_by', 'modified_on', 'modified_by', 'discontinious', 'discontinious_on','assessment', 'slot_time_from','slot_time_to','theropy','theropyselect','chief_complaints','diagnosis','remarks','medical_history']
...
class AssessmentTableAdmin(admin.ModelAdmin):
    list_display = ['id','clienttable', 'therapist', 'date_of_assessment','prenatal_history', 'family_history', 'development_history', 'school_history', 'tests_administered','test_admin','qutient','dev_years','dev_months', 'behavioural_observation','test_results', 'impression', 'recommendations', 'created_on', 'created_by', 'modified_on', 'modified_by', 'email_sent', 'version', 'Status']
...
class UserAdmin(admin.ModelAdmin):
    list_display = ['id','username', 'department', 'password', 'signature', 'created_by', 'is_superuser', 'is_staff', 'is_active', 'created_on']
