...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    signature = models.FileField(upload_to='signature', blank=True)
...
class Assesment(models.Model):
    ...
    qutient=models.CharField(max_length=100, null=True,blank=True)
    dev_years=models.CharField(max_length=100, null=True,blank=True)
    dev_months=models.CharField(max_length=100, null=True,blank=True)
    behavioural_observation = models.TextField()
    test_results = models.IntegerField(null=True,blank=True)
